 ...
 */
const mouseRay = (nmouse, x, y, arr, renderer, camera, params = {}) => {
    let pickParams = {}
    ...
    pickParams.x = params.x
    pickParams.y = params.y
    ...
    point ? console.log(point.normal) : null
    return point
}

export { handleMouseMove, handleMouseDown, mouseRay }
