...
var PanoramaControls = function (object, domElement) {
    ...
    this.mousedown = function (event) {
        ...
        switch (event.button) {
            case 0:
                this.dragOn = true
                this.lastDrag.x = event.pageX
                this.lastDrag.y = event.pageY
                break
        }
    }
    ...
    this.mousemove = function (event) {
        if (this.dragOn) {
            ...
            const deltaX = this.lastDrag.x - event.pageX
            this.lastDrag.x = event.pageX
            const deltaY = this.lastDrag.y - event.pageY
            this.lastDrag.y = event.pageY

            this.moveState.yawLeft = -deltaX / halfWidth
            this.moveState.pitchDown = -deltaY / halfHeight
    ...
    this.update = function (delta) {
        ...
        this.rotationVector.x *= attenuation
        this.rotationVector.y *= attenuation
